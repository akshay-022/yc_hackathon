  ...
  return (
    <div className="h-full flex flex-col bg-gray-900 rounded-lg overflow-hidden">
      <div className="flex h-full flex-col lg:flex-row">
        <div className="w-full lg:w-60 h-48 lg:h-full bg-gray-900 p-3 sm:p-4 border-b lg:border-r lg:border-b-0 border-gray-800 overflow-hidden">
          <div className="flex lg:hidden justify-between items-center mb-4">
            <h3 className="text-white text-base sm:text-lg font-semibold">Conversations</h3>
            <button
          ...
          <h3 className="hidden lg:block text-white text-base sm:text-lg font-semibold mb-4">
            Conversations
          </h3>
          ...
          <div className="h-[calc(100%-3rem)] overflow-y-auto">
            <ul className="space-y-2">
              <li className="hidden lg:block">
                <button
                  onClick={handleNewConversation}
                  className="w-full p-3 rounded-md bg-gray-800 text-gray-200 hover:bg-gray-700 transition-colors text-left"
                >
                  + New Chat
                </button>
              </li>
        ...
        <div className="flex-1 flex flex-col min-h-0 lg:h-full">
          <div className="flex flex-col h-full p-3 sm:p-4">
            ...
            {!hasUserContent && (
              <div className="flex-none bg-gray-700 text-white p-2 rounded-md mb-4">
                I do not have enough information about {username} to mirror them.
              </div>
            )}

            <div className="flex-1 bg-gray-800 rounded-lg mb-4 overflow-hidden min-h-0">
